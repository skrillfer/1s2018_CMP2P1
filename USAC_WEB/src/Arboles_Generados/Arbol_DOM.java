 ...
 * @author fernando
 */
public class Arbol_DOM {
     public void generacion_arbolCJS(NodoDOM raiz) {
        try {
            String contenidoDot = textoDot(raiz);
            escribir("Imagenes/arbol_dom.dot", contenidoDot);

            String fileInputPath = "Imagenes/arbol_dom.dot";
            String fileOutputPath = "Imagenes/DOM_ARBOL.jpg";
    ...
    public String textoDot(NodoDOM raiz) {
        if (raiz == null) {
            return null;
        }
    ...
    public void recorridoAST(NodoDOM nodo, StringBuilder str) {
        if (nodo == null) {
            return;
        }
